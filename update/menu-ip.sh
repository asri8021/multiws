...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/asri8021/permission/main/ipmini | awk '{print $4}' | grep $daftar)
...
Isadmin=$(curl -sS https://raw.githubusercontent.com/huaweipadu/permission/main/ipmini | grep $MYIP | awk '{print $5}')
if [ "$Isadmin" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
